  ...
  <div>
    ...
    <article>
      ...
      <main class="pt-20 md:pt-28 lg:pt-36 pb-9 md:pb-14 lg:pb-8">
        <div class="w-max mx-auto flex gap-x-2 sm:gap-x-4 items-center p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-[#F9F9FA]">
          <button
            @click="activeTab = 'main'"
            :class="[
              'py-1.5 px-3 sm:py-2 sm:px-5 text-base sm:text-2xl font-medium tracking-tight transition-all duration-300',
              activeTab === 'main' ? 'text-adura-black bg-white rounded-lg' : 'text-[#BBB] bg-transparent'
            ]"
          >
            Main plot
          </button>
          <button
            @click="activeTab = 'side'"
            :class="[
              'py-1.5 px-3 sm:py-2 sm:px-5 text-base sm:text-2xl font-medium tracking-tight transition-all duration-300',
              activeTab === 'side' ? 'text-adura-black bg-white rounded-lg' : 'text-[#BBB] bg-transparent'
            ]"
          >
            Side quests
          </button>
        ...
        <Transition name="fade" mode="out-in">
          ...
          <article class="relative group rounded-2xl md:rounded-3xl lg:col-span-2 overflow-hidden">
            ...
            <div class="quest-overlay absolute inset-0 w-full h-full rounded-2xl md:rounded-3xl bg-[#663F254D] backdrop-blur p-4 md:p-8 flex flex-col gap-y-1.5 md:gap-y-2 opacity-100 lg:opacity-0 lg:translate-y-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] lg:group-hover:delay-100">
              <div class="quest-content-line -ml-1 md:-ml-2 flex flex-wrap gap-1.5 items-center lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[500ms]">
                ...
                <p class="hidden 2xl:block rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">Branding</p>
                <p class="hidden 2xl:block rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">Website design</p>
                <p class="hidden 2xl:block rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">Framer development</p>
                <p class="2xl:hidden rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">+3</p>
              </div>
              <p class="quest-content-line text-base md:text-xl font-normal text-[#E0E0E0] tracking-tight lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[600ms]">A smart quoting platform for contractors. I designed the web and mobile experience, defined user flows, and built the Framer landing page for launch.</p>
              <NuxtLink to="https://quoting.ai/" target="_blank" class="quest-content-line mt-auto py-1.5 md:py-2 pl-3 md:pl-4 pr-3 md:pr-3.5 rounded-2xl md:rounded-3xl w-max flex gap-x-1 md:gap-x-[5px] items-center bg-white hover:brightness-95 hover:scale-105 transition-all duration-200 ease-out lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:group-hover:delay-[700ms]">
                <p class="text-base md:text-lg font-normal text-[#848484] tracking-tight">See website</p>
          ...
          <article class="relative group rounded-2xl md:rounded-3xl overflow-hidden">
            ...
            <div class="quest-overlay absolute inset-0 w-full h-full rounded-2xl md:rounded-3xl bg-[#255E4B4D] backdrop-blur p-4 md:p-8 flex flex-col gap-y-1.5 md:gap-y-2 opacity-100 lg:opacity-0 lg:translate-y-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] lg:group-hover:delay-100">
              <div class="quest-content-line -ml-1 md:-ml-2 flex flex-wrap gap-1.5 items-center lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[500ms]">
                ...
                <p class="hidden 2xl:block rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">Admin dashboard</p>
                <p class="2xl:hidden rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">+1</p>
              </div>
              <p class="quest-content-line text-base md:text-xl font-normal text-[#E0E0E0] tracking-tight lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[600ms]">A fintech wallet pivot. I redesigned the mobile app to clarify the brand's new direction and simplify user interaction.</p>
              <NuxtLink to="https://apps.apple.com/ng/app/sciart-finance/id6584520980" target="_blank" class="quest-content-line mt-auto py-1.5 md:py-2 pl-3 md:pl-4 pr-3 md:pr-3.5 rounded-2xl md:rounded-3xl w-max flex gap-x-1 md:gap-x-[5px] items-center bg-white hover:brightness-95 hover:scale-105 transition-all duration-200 ease-out lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:group-hover:delay-[700ms]">
                <p class="text-base md:text-lg font-normal text-[#848484] tracking-tight">View site</p>
                <svg class="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.998 8.05C16.998 7.78478 16.8926 7.53043 16.7051 7.34289C16.5176 7.15536 16.2632 7.05 15.998 7.05L7.99799 7C7.73277 7 7.47842 7.10536 7.29088 7.29289C7.10334 7.48043 6.99799 7.73478 6.99799 8C6.99799 8.26522 7.10334 8.51957 7.29088 8.70711C7.47842 8.89464 7.73277 9 7.99799 9H13.558L5.28799 17.29C5.19426 17.383 5.11986 17.4936 5.06909 17.6154C5.01833 17.7373 4.99219 17.868 4.99219 18C4.99219 18.132 5.01833 18.2627 5.06909 18.3846C5.11986 18.5064 5.19426 18.617 5.28799 18.71C5.38095 18.8037 5.49155 18.8781 5.61341 18.9289C5.73527 18.9797 5.86597 19.0058 5.99799 19.0058C6.13 19.0058 6.2607 18.9797 6.38256 18.9289C6.50442 18.8781 6.61502 18.8037 6.70799 18.71L14.998 10.42V16C14.998 16.2652 15.1033 16.5196 15.2909 16.7071C15.4784 16.8946 15.7328 17 15.998 17C16.2632 17 16.5176 16.8946 16.7051 16.7071C16.8926 16.5196 16.998 16.2652 16.998 16V8.05Z" fill="#AAAAAA"/>
                </svg>
              </NuxtLink>
          ...
          <div class="lg:col-span-3 grid grid-cols-1 grid-rows-[repeat(2,300px)] lg:grid-cols-2 lg:grid-rows-1 gap-4 lg:gap-x-8 lg:items-center">
            <article class="h-full relative group rounded-2xl md:rounded-3xl overflow-hidden">
              ...
              <div class="quest-overlay absolute inset-0 w-full h-full rounded-2xl md:rounded-3xl bg-[#574A0C4D] backdrop-blur p-4 md:p-8 flex flex-col gap-y-1.5 md:gap-y-2 opacity-100 lg:opacity-0 lg:translate-y-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-500 ease-out">
                <div class="quest-content-line -ml-1 md:-ml-2 flex flex-wrap gap-1.5 items-center lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out delay-[400ms]">
                ...
                <p class="quest-content-line text-base md:text-xl font-normal text-[#E0E0E0] tracking-tight lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[600ms]">A process-building agency. I developed the brand identity and designed the landing page to reflect their structured approach.</p>
                <NuxtLink to="https://main.d1scst0n43xrzm.amplifyapp.com/" target="_blank" class="quest-content-line mt-auto py-1.5 md:py-2 pl-3 md:pl-4 pr-3 md:pr-3.5 rounded-2xl md:rounded-3xl w-max flex gap-x-1 md:gap-x-[5px] items-center bg-white hover:brightness-95 hover:scale-105 transition-all duration-200 ease-out lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:group-hover:delay-[700ms]">
            ...
            <article class="h-full relative group rounded-2xl md:rounded-3xl overflow-hidden">
              ...
              <div class="quest-overlay absolute inset-0 w-full h-full rounded-2xl md:rounded-3xl bg-[#346EA34D] backdrop-blur p-4 md:p-8 flex flex-col gap-y-1.5 md:gap-y-2 opacity-100 lg:opacity-0 lg:translate-y-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-500 ease-out">
                <div class="quest-content-line -ml-1 md:-ml-2 flex flex-wrap gap-1.5 items-center lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out delay-[400ms]">
                  <h2 class="m-0 text-2xl md:text-4xl text-white">SHARE!</h2>
                  <p class="rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">Mobile app</p>
                </div>
                <p class="quest-content-line text-base md:text-xl font-normal text-[#E0E0E0] tracking-tight lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[600ms]">A contact-sharing app powered by QR and short links. I designed the mobile experience to make sharing fast, secure, and effortless.</p>
                <NuxtLink to="https://www.figma.com/proto/Il93Fl2D9R46MM5S7wkK6j/Share--app?node-id=29612-13590&p=f&t=nOzbllfohBI54c1j-0&scaling=scale-down&content-scaling=fixed&page-id=5845%3A93856&starting-point-node-id=29612%3A13590&show-proto-sidebar=1" target="_blank" class="quest-content-line mt-auto py-1.5 md:py-2 pl-3 md:pl-4 pr-3 md:pr-3.5 rounded-2xl md:rounded-3xl w-max flex gap-x-1 md:gap-x-[5px] items-center bg-white hover:brightness-95 hover:scale-105 transition-all duration-200 ease-out lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:group-hover:delay-[700ms]">
                  <p class="text-base md:text-lg font-normal text-[#848484] tracking-tight">See prototype</p>
                  <svg class="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16.998 8.05C16.998 7.78478 16.8926 7.53043 16.7051 7.34289C16.5176 7.15536 16.2632 7.05 15.998 7.05L7.99799 7C7.73277 7 7.47842 7.10536 7.29088 7.29289C7.10334 7.48043 6.99799 7.73478 6.99799 8C6.99799 8.26522 7.10334 8.51957 7.29088 8.70711C7.47842 8.89464 7.73277 9 7.99799 9H13.558L5.28799 17.29C5.19426 17.383 5.11986 17.4936 5.06909 17.6154C5.01833 17.7373 4.99219 17.868 4.99219 18C4.99219 18.132 5.01833 18.2627 5.06909 18.3846C5.11986 18.5064 5.19426 18.617 5.28799 18.71C5.38095 18.8037 5.49155 18.8781 5.61341 18.9289C5.73527 18.9797 5.86597 19.0058 5.99799 19.0058C6.13 19.0058 6.2607 18.9797 6.38256 18.9289C6.50442 18.8781 6.61502 18.8037 6.70799 18.71L14.998 10.42V16C14.998 16.2652 15.1033 16.5196 15.2909 16.7071C15.4784 16.8946 15.7328 17 15.998 17C16.2632 17 16.5176 16.8946 16.7051 16.7071C16.8926 16.5196 16.998 16.2652 16.998 16V8.05Z" fill="#AAAAAA"/>
                  </svg>
                </NuxtLink>
          ...
          <article class="relative group rounded-2xl md:rounded-3xl overflow-hidden">
            ...
            <div class="quest-overlay absolute inset-0 w-full h-full rounded-2xl md:rounded-3xl bg-[#082B4B4D] backdrop-blur p-4 md:p-8 flex flex-col gap-y-1.5 md:gap-y-2 opacity-100 lg:opacity-0 lg:translate-y-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] lg:group-hover:delay-100">
              <div class="quest-content-line -ml-1 md:-ml-2 flex flex-wrap gap-1.5 items-center lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[500ms]">
                ...
                <p class="hidden 2xl:block rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">Mobile app</p>
                <p class="hidden 2xl:block rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">Admin dashboard</p>
                <p class="2xl:hidden rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">+2</p>
              </div>
              <p class="quest-content-line text-base md:text-xl font-normal text-[#E0E0E0] tracking-tight lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[600ms]">I helped design BorderPal's web app, creating a clean, intuitive experience that simplifies cross-border payments and business wallet management.</p>
              <NuxtLink to="https://apps.apple.com/ng/app/borderpal/id1567748500" target="_blank" class="quest-content-line mt-auto py-1.5 md:py-2 pl-3 md:pl-4 pr-3 md:pr-3.5 rounded-2xl md:rounded-3xl w-max flex gap-x-1 md:gap-x-[5px] items-center bg-white hover:brightness-95 hover:scale-105 transition-all duration-200 ease-out lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:group-hover:delay-[700ms]">
                <p class="text-base md:text-lg font-normal text-[#848484] tracking-tight">See live app</p>
                <svg class="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.998 8.05C16.998 7.78478 16.8926 7.53043 16.7051 7.34289C16.5176 7.15536 16.2632 7.05 15.998 7.05L7.99799 7C7.73277 7 7.47842 7.10536 7.29088 7.29289C7.10334 7.48043 6.99799 7.73478 6.99799 8C6.99799 8.26522 7.10334 8.51957 7.29088 8.70711C7.47842 8.89464 7.73277 9 7.99799 9H13.558L5.28799 17.29C5.19426 17.383 5.11986 17.4936 5.06909 17.6154C5.01833 17.7373 4.99219 17.868 4.99219 18C4.99219 18.132 5.01833 18.2627 5.06909 18.3846C5.11986 18.5064 5.19426 18.617 5.28799 18.71C5.38095 18.8037 5.49155 18.8781 5.61341 18.9289C5.73527 18.9797 5.86597 19.0058 5.99799 19.0058C6.13 19.0058 6.2607 18.9797 6.38256 18.9289C6.50442 18.8781 6.61502 18.8037 6.70799 18.71L14.998 10.42V16C14.998 16.2652 15.1033 16.5196 15.2909 16.7071C15.4784 16.8946 15.7328 17 15.998 17C16.2632 17 16.5176 16.8946 16.7051 16.7071C16.8926 16.5196 16.998 16.2652 16.998 16V8.05Z" fill="#AAAAAA"/>
                </svg>
              </NuxtLink>
          ...
          <article class="relative group rounded-2xl md:rounded-3xl lg:col-span-2 overflow-hidden">
            ...
            <div class="quest-overlay absolute inset-0 w-full h-full rounded-2xl md:rounded-3xl bg-[#451FB24D] backdrop-blur p-4 md:p-8 flex flex-col gap-y-1.5 md:gap-y-2 opacity-100 lg:opacity-0 lg:translate-y-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] lg:group-hover:delay-100">
              <div class="quest-content-line -ml-1 md:-ml-2 flex flex-wrap gap-1.5 items-center lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[500ms]">
                <h2 class="m-0 text-2xl md:text-4xl text-white">TANWA</h2>
                <p class="rounded-[40px] px-3 md:px-4 py-0.5 md:py-1 font-spline text-sm md:text-base text-[#667085] font-normal leading-[18px] antialiased tracking-tighter bg-white">Mobile app</p>
              </div>
              <p class="quest-content-line text-base md:text-xl font-normal text-[#E0E0E0] tracking-tight lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 ease-out lg:group-hover:delay-[600ms]">A sustainability-focused lifestyle app. I designed the mobile experience to help users make eco-conscious decisions with ease.</p>
              <NuxtLink to="https://apps.apple.com/ng/app/tanwa/id6520389309" target="_blank" class="quest-content-line mt-auto py-1.5 md:py-2 pl-3 md:pl-4 pr-3 md:pr-3.5 rounded-2xl md:rounded-3xl w-max flex gap-x-1 md:gap-x-[5px] items-center bg-white hover:brightness-95 hover:scale-105 transition-all duration-200 ease-out lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:group-hover:delay-[700ms]">
                <p class="text-base md:text-lg font-normal text-[#848484] tracking-tight">See live app</p>
                <svg class="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.998 8.05C16.998 7.78478 16.8926 7.53043 16.7051 7.34289C16.5176 7.15536 16.2632 7.05 15.998 7.05L7.99799 7C7.73277 7 7.47842 7.10536 7.29088 7.29289C7.10334 7.48043 6.99799 7.73478 6.99799 8C6.99799 8.26522 7.10334 8.51957 7.29088 8.70711C7.47842 8.89464 7.73277 9 7.99799 9H13.558L5.28799 17.29C5.19426 17.383 5.11986 17.4936 5.06909 17.6154C5.01833 17.7373 4.99219 17.868 4.99219 18C4.99219 18.132 5.01833 18.2627 5.06909 18.3846C5.11986 18.5064 5.19426 18.617 5.28799 18.71C5.38095 18.8037 5.49155 18.8781 5.61341 18.9289C5.73527 18.9797 5.86597 19.0058 5.99799 19.0058C6.13 19.0058 6.2607 18.9797 6.38256 18.9289C6.50442 18.8781 6.61502 18.8037 6.70799 18.71L14.998 10.42V16C14.998 16.2652 15.1033 16.5196 15.2909 16.7071C15.4784 16.8946 15.7328 17 15.998 17C16.2632 17 16.5176 16.8946 16.7051 16.7071C16.8926 16.5196 16.998 16.2652 16.998 16V8.05Z" fill="#AAAAAA"/>
                </svg>
          ...
          <article class="relative group rounded-2xl md:rounded-3xl overflow-hidden">
            ...
            <div class="quest-overlay absolute inset-0 w-full h-full rounded-2xl md:rounded-3xl bg-[#082B4B4D] backdrop-blur p-4 md:p-8 flex flex-col gap-y-1.5 md:gap-y-2 opacity-100 lg:opacity-0 lg:translate-y-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] lg:group-hover:delay-100">
              ...
              <button @click="openVideoModal('https://player.vimeo.com/video/1128061844?h=62201f505b')" class="quest-content-line mt-auto py-1.5 md:py-2 pl-3 md:pl-4 pr-3 md:pr-3.5 rounded-2xl md:rounded-3xl w-max flex gap-x-1 md:gap-x-[5px] items-center bg-white hover:brightness-95 hover:scale-105 transition-all duration-200 ease-out lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:group-hover:delay-[600ms]">
                <p class="text-base md:text-lg font-normal text-[#848484] tracking-tight">Preview</p>
                <svg class="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.998 8.05C16.998 7.78478 16.8926 7.53043 16.7051 7.34289C16.5176 7.15536 16.2632 7.05 15.998 7.05L7.99799 7C7.73277 7 7.47842 7.10536 7.29088 7.29289C7.10334 7.48043 6.99799 7.73478 6.99799 8C6.99799 8.26522 7.10334 8.51957 7.29088 8.70711C7.47842 8.89464 7.73277 9 7.99799 9H13.558L5.28799 17.29C5.19426 17.383 5.11986 17.4936 5.06909 17.6154C5.01833 17.7373 4.99219 17.868 4.99219 18C4.99219 18.132 5.01833 18.2627 5.06909 18.3846C5.11986 18.5064 5.19426 18.617 5.28799 18.71C5.38095 18.8037 5.49155 18.8781 5.61341 18.9289C5.73527 18.9797 5.86597 19.0058 5.99799 19.0058C6.13 19.0058 6.2607 18.9797 6.38256 18.9289C6.50442 18.8781 6.61502 18.8037 6.70799 18.71L14.998 10.42V16C14.998 16.2652 15.1033 16.5196 15.2909 16.7071C15.4784 16.8946 15.7328 17 15.998 17C16.2632 17 16.5176 16.8946 16.7051 16.7071C16.8926 16.5196 16.998 16.2652 16.998 16V8.05Z" fill="#AAAAAA"/>
                </svg>
          ...
          <article class="relative group rounded-2xl md:rounded-3xl overflow-hidden">
            ...
            <div class="quest-overlay absolute inset-0 w-full h-full rounded-2xl md:rounded-3xl bg-[#082B4B4D] backdrop-blur p-4 md:p-8 flex flex-col gap-y-1.5 md:gap-y-2 opacity-100 lg:opacity-0 lg:translate-y-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] lg:group-hover:delay-100">
              ...
              <button @click="openVideoModal('https://player.vimeo.com/video/1126638575?h=82360be1fc')" class="quest-content-line mt-auto py-1.5 md:py-2 pl-3 md:pl-4 pr-3 md:pr-3.5 rounded-2xl md:rounded-3xl w-max flex gap-x-1 md:gap-x-[5px] items-center bg-white hover:brightness-95 hover:scale-105 transition-all duration-200 ease-out lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:group-hover:delay-[600ms]">
                <p class="text-base md:text-lg font-normal text-[#848484] tracking-tight">Preview</p>
                <svg class="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.998 8.05C16.998 7.78478 16.8926 7.53043 16.7051 7.34289C16.5176 7.15536 16.2632 7.05 15.998 7.05L7.99799 7C7.73277 7 7.47842 7.10536 7.29088 7.29289C7.10334 7.48043 6.99799 7.73478 6.99799 8C6.99799 8.26522 7.10334 8.51957 7.29088 8.70711C7.47842 8.89464 7.73277 9 7.99799 9H13.558L5.28799 17.29C5.19426 17.383 5.11986 17.4936 5.06909 17.6154C5.01833 17.7373 4.99219 17.868 4.99219 18C4.99219 18.132 5.01833 18.2627 5.06909 18.3846C5.11986 18.5064 5.19426 18.617 5.28799 18.71C5.38095 18.8037 5.49155 18.8781 5.61341 18.9289C5.73527 18.9797 5.86597 19.0058 5.99799 19.0058C6.13 19.0058 6.2607 18.9797 6.38256 18.9289C6.50442 18.8781 6.61502 18.8037 6.70799 18.71L14.998 10.42V16C14.998 16.2652 15.1033 16.5196 15.2909 16.7071C15.4784 16.8946 15.7328 17 15.998 17C16.2632 17 16.5176 16.8946 16.7051 16.7071C16.8926 16.5196 16.998 16.2652 16.998 16V8.05Z" fill="#AAAAAA"/>
                </svg>
          ...
          <article class="relative group rounded-2xl md:rounded-3xl overflow-hidden">
            ...
            <div class="quest-overlay absolute inset-0 w-full h-full rounded-2xl md:rounded-3xl bg-[#082B4B4D] backdrop-blur p-4 md:p-8 flex flex-col gap-y-1.5 md:gap-y-2 opacity-100 lg:opacity-0 lg:translate-y-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] lg:group-hover:delay-100">
              ...
              <button @click="openVideoModal('https://player.vimeo.com/video/1126638814?h=f18962106d')" class="quest-content-line mt-auto py-1.5 md:py-2 pl-3 md:pl-4 pr-3 md:pr-3.5 rounded-2xl md:rounded-3xl w-max flex gap-x-1 md:gap-x-[5px] items-center bg-white hover:brightness-95 hover:scale-105 transition-all duration-200 ease-out lg:opacity-0 lg:translate-y-2 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:group-hover:delay-[600ms]">
                <p class="text-base md:text-lg font-normal text-[#848484] tracking-tight">Preview</p>
                <svg class="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.998 8.05C16.998 7.78478 16.8926 7.53043 16.7051 7.34289C16.5176 7.15536 16.2632 7.05 15.998 7.05L7.99799 7C7.73277 7 7.47842 7.10536 7.29088 7.29289C7.10334 7.48043 6.99799 7.73478 6.99799 8C6.99799 8.26522 7.10334 8.51957 7.29088 8.70711C7.47842 8.89464 7.73277 9 7.99799 9H13.558L5.28799 17.29C5.19426 17.383 5.11986 17.4936 5.06909 17.6154C5.01833 17.7373 4.99219 17.868 4.99219 18C4.99219 18.132 5.01833 18.2627 5.06909 18.3846C5.11986 18.5064 5.19426 18.617 5.28799 18.71C5.38095 18.8037 5.49155 18.8781 5.61341 18.9289C5.73527 18.9797 5.86597 19.0058 5.99799 19.0058C6.13 19.0058 6.2607 18.9797 6.38256 18.9289C6.50442 18.8781 6.61502 18.8037 6.70799 18.71L14.998 10.42V16C14.998 16.2652 15.1033 16.5196 15.2909 16.7071C15.4784 16.8946 15.7328 17 15.998 17C16.2632 17 16.5176 16.8946 16.7051 16.7071C16.8926 16.5196 16.998 16.2652 16.998 16V8.05Z" fill="#AAAAAA"/>
                </svg>
    ...
    <Teleport to="body">
      <Transition name="modal">
        <div v-if="videoModalOpen" @click="closeVideoModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/90 p-4 md:p-8">
          <div @click.stop class="relative w-full max-w-6xl aspect-video">
