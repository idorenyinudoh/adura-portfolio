  ...
  <div class="before:fixed before:inset-0 before:-z-10 before:bg-[url(~/assets/images/landscape-background.png)] before:bg-no-repeat before:bg-cover">
    <div class="font-extrabold font-monument-extended text-white text-4xl sm:text-5xl md:text-7xl lg:text-8xl">
      ...
      <div class="flex">
        ...
        <p class="hidden sm:block h-max self-center px-2.5 md:px-[18px] lg:px-6 py-[2px] md:py-1 -ml-[33px] lg:-ml-[30px] -mb-[10px] md:-mb-[15px] lg:-mb-5 lg:leading-[30px] rounded-2xl bg-adura-purple text-adura-black text-xs md:text-base font-satoshi font-normal">Product Designer</p>
      </div>
    </div>
    ...
    <p class="text-white text-base md:text-lg lg:text-2xl font-normal mt-12 lg:mt-16 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[75vw]">
