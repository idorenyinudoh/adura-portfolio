...
<template>
  <div>
    ...
    <div class="relative pt-[75%] sm:pt-[60%] lg:pt-[40.5%] -mx-[8.3vw] lg:mx-0 mt-16 lg:mt-4">
      <NuxtImg provider="cloudinary" class="absolute top-0 left-0 w-full h-full object-cover rounded-none lg:rounded-2xl border-2 border-solid border-adura-black" :src="`/projects/${heroImage}`" :alt="`image of user on ${projectName}'s platform`" />
    </div>
