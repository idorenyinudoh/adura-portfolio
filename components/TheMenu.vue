...
<template>
  <button class="fixed bottom-4 left-[8.3vw] rounded-full bg-adura-purple grid grid-rows-[max-content_max-content] justify-center content-center w-[90px] lg:w-[130px] h-[90px] lg:h-[130px] font-semibold text-adura-black text-sm lg:text-base" @click="showNav">
